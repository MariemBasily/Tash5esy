    ...
    return Container(
      ...
      child: const Column(
        children: [
          ...
          // Input Fields
          CustomTextField(
              label: 'Do you have any allergies?', initialValue: 'NO'),
          CustomTextField(
              label: 'What kind of allergies do you have?',
              initialValue: 'Eye Allergies'),
          CustomTextField(
              label: 'When was your allergy first diagnosed?',
              initialValue: '7 years ago'),
          CustomTextField(
              label: 'Do you have any family members with allergies?',
              initialValue: 'No'),
          CustomTextField(
              label: 'What happens to your body when exposed to an allergen?',
              initialValue: 'Wheezing and difficulty breathing'),
          CustomTextField(
              label: 'Have you experienced any new allergens recently?',
              initialValue: 'No'),

          CustomTextField(
              label:
                  'Do you have a family history of chronic diseases such as cancer, diabetes, heart disease?',
              initialValue: 'If yes say what is?'),
          CustomTextField(
              label:
          ...
          CustomTextField(
              ...
              initialValue: 'If yes say what is?'),
          CustomTextField(
              label: 'Do you have a disabled person in your family?',
              initialValue: 'Yes'),
